...
回归主题，自由是什么？为何我们需要自由？请参考萨特、海德格尔和萨谬一大堆哲学家，而如何让你更自由，是我想探讨的。
...
我们感谢于资本帮助社会发展带来的便利，同时资本也具备很多改进之处，极化加速是普通个体最绝望的：你越努力，和资本家差距越大，稍候补充点数据，包括国内和世界银行的可信数据，看了你会更绝望，历史已经充分证明了这一点。
...
实现的方式是借鉴发展几十亿年的真菌生态的协作和涌现的创新和实践，构建基于去中心化保障的协作协议，从而建立**新的协作关系**，当然，其中最重要的是~~**价值再分配**~~，**价值定义** 也包括延伸的价值分配和自由的时间、空间和选择权。
我们举个例子：淘宝，中心化电商，那如果去中心化电商呢？Google，我们看到的是一个科技巨头，实际上，79%的收入依然来自于搜索广告模式，而这些很大一部分来自于免费的互联网，Youtube和TicTok更是重度依赖Web2的个体内容创作者，当然，也出现了封闭内容的崛起，例如小红书。
这一切，本质是一种协作关系，我们可以重构，基于Web3构建的Trustless，Permissless和Decentralized的应用体系。
...
### 帮助你建立真正的DApp
提供系列的基础设施和协议构建的工具和社区、流程，帮助任何人构建自己的协议和对应的DApp。
Infra：AirAccount+SuperPaymaster，区块链底层构建的去中心化共识和协作基础，构建无许可、无需信任和去中心化涌现的底层管道，真菌网络的基础。
Protocol：Mycelium社区会构建一个轻社区，提供公共物品花园：Park协议，提供协议构造模板，提供OpenNest孵化，任何人的创新舞台。
DApp：通过建设真正的DApp，如同上面提到的去中心化滴滴、美团（不一定合理和可行），探索和践行真正的新的经济模型。

Community、个体和Task构成良性循环。
COS72整合身份、任务以及协作（基于身份+reputation）完成onboarding，激励和check，我们会引入社区AI，模型我在选，大概有些list的
![循环流程](https://raw.githubusercontent.com/jhfnetboy/MarkDownImg/main/img/202601251105894.svg)
...
一些思考：
根据耗散结构的指数，判断你的标准，例如你完全成年，不需要真菌倾斜供养，那就要分给其他个体资源,而如何构建这个自动调节又低成本的供养和分配的动态关系，是一个研究课题。

...
Our hybrid evaluation framework provides strong evidence for the viability of the SuperPaymaster system. The real-world transaction benchmarking (Sec 6.1) confirmed the system's efficiency, while the pilot user study (Sec 6.3) validated the HCI-driven design. The computational simulations (Sec 6.2) further demonstrated the architecture's scalability and decentralization properties. These results directly address the research questions posed in this paper.
...
This research addressed the critical barrier of blockchain gas payment complexity that impedes widespread Web3 adoption. Through a Design Science Research methodology, we designed and built SuperPaymaster, a decentralized, user-centric gas payment system. Our hybrid evaluation, combining real-world benchmarking, simulation, and a pilot user study, provides strong evidence that our approach significantly reduces transaction costs and complexity while preserving decentralization.
